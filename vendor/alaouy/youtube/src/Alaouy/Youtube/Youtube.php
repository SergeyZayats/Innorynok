...
class Youtube
{
     ...
     * @throws \Exception
     * 
     * default was     public function getVideoInfo($vId, $part = ['id', 'snippet', 'contentDetails', 'player', 'statistics', 'status'])
     */
    public function getVideoInfo($vId, $part = ['id', 'snippet', 'contentDetails', 'player', 'statistics', 'status'])
    {
        ...
        public function getVideoSnippet($vId, $part = ['snippet'])
    {
        $API_URL = $this->getApi('videos.list');
        $params = array(
            'id' => is_array($vId) ? implode(',', $vId) : $vId,
    ...
    public function getVideoContentDetails($vId, $part = ['contentDetails'])
    {
        $API_URL = $this->getApi('videos.list');
        $params = array(
            'id' => is_array($vId) ? implode(',', $vId) : $vId,
     ...
     * @throws \Exception
     */
    public function getPlaylistItemsSnippetAndContentDetailsByPlaylistId($playlistId, $pageToken = '', $maxResults = 50, $part = ['snippet', 'contentDetails'])
    {
        $API_URL = $this->getApi('playlistItems.list');
        $params = array(
            'playlistId' => $playlistId,
