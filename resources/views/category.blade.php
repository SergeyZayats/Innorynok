          ...
          <div class="card card-preview rotate-in">
            <div class="card-content">
              <div class="col-xs-4 col-sm-12 image-column">
                ...
                <div>
                  <button type="button" class="btn btn-default btn-md"><a href="/playlist/{{$dataFromYoutube[$i]['playlistId']}}">{{$dataFromYoutube[$i]['title']}}</a></button>
                </div>
...
@include('layouts.list_of_playlists')
